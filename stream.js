...
panel_result['content'] = content
  ...
  async function check_youtube_premium() {
    ...
    let 𝒚𝒐𝒖𝒕𝒖𝒃𝒆_𝒄𝒉𝒆𝒄𝒌_𝒓𝒆𝒔𝒖𝒍𝒕 = 'ʏᴏᴜᴛᴜʙᴇ: '
  ...
  async function check_netflix() {
    ...
    let 𝒏𝒆𝒕𝒇𝒍𝒊𝒙_𝒄𝒉𝒆𝒄𝒌_𝒓𝒆𝒔𝒖𝒍𝒕 = 'ɴᴇᴛғʟɪx: '
    ...
    await inner_check(81215567)
      .then((code) => {
        ...
        𝒏𝒆𝒕𝒇𝒍𝒊𝒙_𝒄𝒉𝒆𝒄𝒌_𝒓𝒆𝒔𝒖𝒍𝒕 += '已完整解锁 ➺ '  +`${getFlagEmoji(code)} ` 
      ...
      .then((code) => {
        ...
        𝒏𝒆𝒕𝒇𝒍𝒊𝒙_𝒄𝒉𝒆𝒄𝒌_𝒓𝒆𝒔𝒖𝒍𝒕 += '仅自制剧 ➺ ' + `${getFlagEmoji(code)} ` 
        return Promise.reject('BreakSignal')
      })
      .catch((error) => {
